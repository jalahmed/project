...
class Paginator{
	...
	function paginate($default_ipp='7')
	{
		if($_GET['ipp'] == 'All')
		{
		...
		if($this->num_pages > 2)
		{
			$this->return = ($this->current_page != 1 And $this->items_total >= 5) ? "<a class=\"paginate\" href=\"?page=$prev_page&ipp=$this->items_per_page$this->querystring\">&laquo; Previous</a> ":"<span class=\"inactive\" href=\"#\">&laquo; Previous</span> ";
			...
			$this->return .= (($this->current_page != $this->num_pages And $this->items_total >= 5) And ($_GET['page'] != 'All')) ? "<a class=\"paginate\" href=\"?page=$next_page&ipp=$this->items_per_page$this->querystring\">Next &raquo;</a>\n":"<span class=\"inactive\" href=\"#\">&raquo; Next</span>\n";
	...
	{
		$items = '';
		$ipp_array = array(5,25,50,100,'All');
