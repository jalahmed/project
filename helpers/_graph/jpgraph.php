...
//require_once("helpers/jpgraph/jpg-config.inc.php");
//require_once("helpers/jpgraph/jpgraph_gradient.php");
//require_once("helpers/jpgraph/jpgraph_errhandler.inc.php");
//require_once("helpers/jpgraph/jpgraph_ttf.inc.php");
//require_once("helpers/jpgraph/jpgraph_rgb.inc.php");
//require_once("helpers/jpgraph/jpgraph_text.inc.php");
//require_once("helpers/jpgraph/jpgraph_legend.inc.php");
//require_once("helpers/jpgraph/jpgraph_theme.inc.php");
//require_once("helpers/jpgraph/gd_image.inc.php");
        ...
        if( empty($_GET[_CSIM_DISPLAY]) ) {
            ...
            if( $this->csimcachename != '' ) {
                ...
                $htmlwrap = $this->GetHTMLImageMap($aCSIMName)."\n".
                            //'<img src="'.site_url().CSIMCACHE_HTTP_DIR.$tmp.'" ismap="ismap" usemap="#'.$aCSIMName.' width="'.$this->img->width.'" height="'.$this->img->height."\" alt=\"".$this->iCSIMImgAlt."\" />\n";
